...
<template>
  <div>
    <h1 class="text-2xl font-bold text-slate-900 dark:text-white mb-8">{{ t('theTeam') }}</h1>
    <div class="space-y-8">
      <article
      ...
      >
        ...
        <div>
          <h2 class="text-lg font-semibold text-slate-900 dark:text-white">{{ dev.name }} · {{ dev.role }}</h2>
